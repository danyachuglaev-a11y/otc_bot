...
# ============================================================
# 8. ВЕБ-СЕРВЕР ДЛЯ MINI APP (С ПОДДЕРЖКОЙ GET И CORS)
# ============================================================
async def handle_api(request):
    """Обрабатывает запросы от Mini App (GET и POST)"""
    ...
    if request.method == 'GET':
        # Возвращаем информацию о боте для проверки
    ...
    print(f"📡 API POST: {endpoint} | user_id: {user_id}")
    ...
    # --- ОНЛАЙН ---
        ...
        import random
        return web.json_response({'online': random.randint(30, 200)}, headers=headers)
...
async def start_web_server():
    app = web.Application()
    app.router.add_route('*', '/{path:.*}', handle_api)  # Принимает GET, POST, OPTIONS
